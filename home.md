...
- **講演要旨の登録は2月17日（火）23時59分 JST までです。**
    - ポスター発表では、<span color="red">3月7日までにオンライン用ポスターファイルを登録</span>する必要があります。
    - 一般口頭発表では、事前に<span color="red">会場において発表ファイルの登録</span>が必要です。詳細は[発表にあたっての注意点](/presentation#口頭発表)をご覧ください。
    - シンポジウム、自由集会、フォーラムについては、大会側では発表ファイルの管理を行いません。
