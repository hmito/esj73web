...
- **発表者は会場内に設置されるスピーカーレディルームにて事前に、発表用のPowerPoint,PDFファイル等を発表用PCへとご自身で登録**していただく必要があります。
- 発表ファイルを入れたUSBメモリ、CD-Rなどをご用意の上、スピーカーレディルームにお越し下さい。
- 発表者は、発表日ごとに指定された提出時間（3月11日：12-14時，3月12日：10-12時，3月13日：10-12時）に発表ファイルを提出ください。
- 公募セッション(3月13日)での口頭発表の発表者は、前日の3月12日10-12時までに発表ファイルを提出してください。
- 発表ファイルを提出した後でも、提出時間内であれば、発表ファイルの差し替えは可能です。
...
- ポスター会場は、3月14日は午前11:00に、3月15日は午前9:00に開場します。
   - オンサイトでのポスター発表者は、発表日が3月14日の方は当日11:00から12:00までの間に、発表日が3月15日の方は当日9:00から10:00までの間にそれぞれポスターの掲示を行ってください。
...
- ポスターの撤収は、3月14日に発表される方は当日午後19:30までに、3月15日に発表される方は当日午後17:00までに必ず行ってください。
...
- シンポジウム、自由集会、フォーラムでは、大会側では発表用PCを用意しません。**企画者または各発表者が自身のPCを持ち込んでの発表**をお願いします。
    - 発表用PCを使用しないため、スピーカーレディルームでの事前のファイル登録作業等は必要ありません。発表に際して自身のPCを持ちこむ必要があるか等については、集会の企画者にご確認ください。
...
- 企画者が希望する場合、発表の様子は業者による録画によりオンデマンド配信が行われます。
