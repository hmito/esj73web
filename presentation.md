...
- 発表者は、事前にスピーカーレディルームにて発表用のPowerPointファイルを発表用PCへと移動・登録していただく必要があります。
    - 詳細については、1月頃に更新予定です。
...
- 企画者が希望する場合、発表の様子は業者による録画が行われます。
    ...
    - 録画は会場に設置された業者からのカメラで行うため、撮影時は会場の様子や講演者の顔が映ります。なお、質疑応答や総合討論については、マイクを通して話された内容についてのみ録音が可能です。
