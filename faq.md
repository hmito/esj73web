...
### Q. 口頭発表を現地で録画し、それをセルフオンデマンドで配信できますか？

A. できません。一般講演での発表に用いる会場のPCでは、講演の録画やその後のデータの取り出しができないためです。また、会場に各自で機材（カメラ、三脚等）を持ち込んでの録画も、講演のスムーズな移行の妨げとなるため、許可されません。
<!---理由付けはこれでいいでしょうか？--->

### Q. 口頭発表をキャンセルしましたが発表は事前に録画しておいたので、それをセルフオンデマンドで配信してもいいですか？

A. できません。キャンセルされた講演は大会プラットフォームから削除されるためです。

### Q. シンポジウム（または自由集会）での講演を予定しているのですが、発表を事前収録しセルフオンデマンドで配信できますか？

A. できません。今大会の（事前に希望された）全てのシンポジウム・自由集会は、業者委託による会場での収録とオンデマンド配信を予定しております。そのため、集会の企画者・講演者によるセルフオンデマンド配信はできない仕様になっています。
