...
- 上記講演とは別に、趣旨説明、コメンテータ、パネラー、ライトニングトークなど講演要旨\(※\)を登録せず行う発表や、集会の企画のみを行うことはできます。
  ...
  - 自由集会については、集会の形式が多様であることも鑑みてシンポジウム・口頭発表と重複しない時間帯に割り当てられる予定です。
- なお、企画可能な集会は、フォーラムの企画を除きこれまで通り1人1件までです。
...
- シンポジウム・自由集会において、講演要旨の登録を伴わない発表を行う場合
...
※2　招待講演者に限ります。\
※3　趣旨説明、コメンテータ、パネラー、ライトニングトークなど、各種集会の企画者が申込時に「講演」として登録していない発表に限ります。
