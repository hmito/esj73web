...
なお、高校生以下を対象とした企画として、現在活躍中の生態学者との交流会「[**みんなのジュニア生態学講座**](/juniorlec)」も開催予定です。自身が高校生、大学生だった頃を振り返りつつ、現在の研究に至った経緯などをお話しいただきます。こちらもぜひご参加ください。
...
これらの**申し込み・登録の操作は原則、顧問や担任の教員または保護者の方**（以下「申込者」）にお願いします。諸手続きに責任を負っていただける方にしてください。なお申込者は、各校2名まで無料参加できる引率者の一人としてカウントされます。必ずしも申込者が引率のために参加する必要はありませんが、残る無料参加できる引率者は一名となる点にご留意ください。
...
1. 初回のみ、申込者のログインIDの取得を行います。[講演申込みサイト](リンク)を開くと種別の選択画面となりますので、「非会員/ジュニアポスター」→「新規申し込み」の順に選び、申込者の氏名（発表者ではありません）、メールアドレス、パスワードを入力してください。登録が済むと、ログインIDがメールアドレス宛に送信されます。
2. 再び[講演申込みサイト](リンク)を開き、「非会員/ジュニアポスター」→「各種申込/変更/確認」の順に選び、ログインIDとパスワードを入力してログインしてください。
3. ログイン後、画面下部にジュニアポスターの新規講演申込ボタンが表示されます。クリックし、入力フォームに従ってポスター賞への応募の有無、現地参加の予定、発表タイトル、発表者全員分の氏名、所属、メールアドレス等を登録してください。
...
発表者および申込者は自動的に大会参加者として登録されますので、**改めての参加登録は不要です**。ただし、以下の参加者は、大会参加登録を各自で行う必要があります。いずれも大会当日まで申し込み可能です。
