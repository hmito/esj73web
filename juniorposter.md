...
- **大会参加申し込み** : 全員
- **ジュニアポスター発表申し込み・要旨登録・ポスター登録** : 生徒の発表に責任を負うことのできる教員または保護者の方（以下「申込責任者」）
...
**各種申し込みは、[申込みサイト](https://iap-jp.org/esj/conf/login.php)にて受け付けています。**
...
### \(2\) 参加申し込み（発表を行う生徒・申込責任者）

締切：**2025年10月31日(金) 23:59 JST**

オンライン・現地、いずれかでの発表を行う生徒（発表者）および申込責任者は、全員以下の手順で大会参加申し込みを行ってください。

1. [ESJ73の各種申込フォーム](https://iap-jp.org/esj/conf/login.php)を開き、種別を「非会員/ジュニアポスター」→「新規申し込み」の順に選び、氏名、**個人メールアドレス**、パスワードを入力してください。登録が済むと、ログインIDがメールアドレス宛に送信されます。
2. 再び[ESJ73の各種申込フォーム](https://iap-jp.org/esj/conf/login.php)を開き、「非会員/ジュニアポスター」→「各種申込/変更/確認」の順に選び、ログインIDとパスワードを入力してログインしてください。
...
1. 申込責任者は[ESJ73の各種申込フォーム](https://iap-jp.org/esj/conf/login.php)を開き、「非会員/ジュニアポスター」→「各種申込/変更/確認」の順に選び、ログインIDとパスワードを入力してログインしてください。
...
登録期間：**2026年1月6日（火）～3月7日（土）23:59**　<!--〆切は変更の可能性あり。要修正の場合Figもチェック-->
...
- ポスター形式は「A4横×4~5枚」または現地発表で一般的な「A0縦×1枚」とします。
    ...
    - 現地発表で用いるポスターボードは、A0ポスターを縦向きで掲載できるサイズです。ボードをはみ出して掲示することはできません。
...
- 賞状は大会プラットフォームから各個人でダウンロードしていただけます（ダウンロード画面へのリンクボタンは受賞発表後～数日以内に利用可能になります）
