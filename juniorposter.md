...
**各種申込みは、[申込みサイト](https://iap-jp.org/esj/conf/login.php)にて受け付けています。**
...
1. [ESJ73の各種申込フォーム](https://iap-jp.org/esj/conf/login.php)を開き、種別を「非会員/ジュニアポスター」→「新規申込み」の順に選び、氏名、**個人メールアドレス**、パスワードを入力してください。登録が済むと、ログインIDがメールアドレス宛に送信されます。
