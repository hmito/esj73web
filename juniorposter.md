...
なお、高校生以下を対象とした企画として、活躍中の若手生態学者との交流会「[**みんなのジュニア生態学講座**](/juniorlec)」も開催予定です。ぜひご参加ください。

## 概要

- 生き物の振る舞いや環境とのつながりなど、生態学に関するテーマならどのような題材でも発表できます。
    - ただし、既に他学会等で発表した内容の場合、そこからどのように発展したかを含めて下さい。
...
- ポスターを発表用の専用Webサイトにアップロードし、参加者が大会期間中に自由に閲覧する形式です。
...
- ジュニアポスターにおいて**発表を担当する生徒の参加費は無料**です。
- 生態学会は**参加のみの場合も大学学部生以下の生徒は無料**です。発表を担当しない生徒の方も、ぜひご参加ください。
...
**発表までに必要な手続きは、顧問や担任の教員または保護者の方（以下「申込責任者」）が行ってください**。**ただし今大会から、発表担当の生徒は10月31日(金)までに、発表担当ではない生徒は1月6日(火)以降に、個別に参加申込の手続きを行う必要があります**。なお申込責任者は、各団体あたり3名の無料参加枠の一人としてカウントされます。必ずしも申込責任者が引率のために参加する必要はありませんが、残る団体ごとの無料参加枠は2名となる点にご留意ください。
...
オンライン・現地のいずれかでの発表を担当する生徒および申込責任者は、全員以下の手順で参加申し込みを行ってください。
...
作成したポスターはPDFに変換の上、大会プラットフォーム（オンライン発表用のWebサイト）へアップロードしてください。

1. 申込責任者へは、1月頃に大会プラットフォームへのログイン情報がメールアドレス宛に送信されますので、案内に沿ってログインしてください。
2. 大会プラットフォームのホーム画面における「発表・プロフィールを登録する」を選び、ポスターとグラフィカルアブストラクト（後述）、必要に応じて説明動画をアップロードしてください。

### \(6\) 参加のみの生徒、申込責任者以外の引率者等の参加登録（該当者各自）

登録期間：**2025年1月6日（月）～大会当日まで手続き可能**

発表担当の生徒および申込責任者以外の参加者は、以下から各自で参加登録を行ってください。無料枠を超える引率者の方については、一般参加者として参加登録を行ってください。
...
- ポスター形式は自由です。「A4横×4枚」を推奨しますが、現地発表で一般的な「A0縦×1枚」でもかまいません。
...
- ポスターのアップロードは申込責任者が行います。期限までに、大会プラットフォーム（オンライン発表用のWebサイト）へポスターとグラフィカルアブストラクトをアップロードしてください。
...
- 参加者とは、コメント機能を使ってやりとりしてください（新たなコメントがあった場合メールで通知があります）。

### 現地会場での発表 (希望者)

- 発表担当者には、大会プラットフォームへのログイン情報が例年1月頃に送信されます。ログイン後、自身の名札をあらかじめ印刷し、当日持参してください。ネームホルダーは会場に用意されています。
...
- ポスターの記述を以下の5つの項目から審査し、最優秀賞・優秀賞を選出します。説明動画等は直接の審査対象とはなりません。
    1. 研究の新規性・独自性
    2. 手法と解釈の適切さ
    3. データの質・量
    4. 論理の妥当性
    5. 情報を伝える工夫・配慮
- 豊かな発想や研究活動へのひたむきな努力が見られるポスターを対象に、審査員特別賞を選出します。
...
発表者（＝ポスターや論文に名前が載る人）として認められるのは、次のような形で研究に貢献をした全ての人です。生徒だけでなく、顧問の先生や大学教員等外部の助言者も該当するかもしれません。
...
例4：**生徒A**が実験・データ収集を担当し、**大学教員Y**が一部の解析と助言を提供。**顧問Y**は大学訪問時に付き添った。  
→ 生徒Aと大学教員Yが発表者に該当。
