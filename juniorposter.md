...
ジュニアポスターの**発表者の参加費は無料**です。学生以外の共著者すべてを含み、人数に制限はありません。発表にあたって生態学会に入会する必要もありません。

また、顧問や担任の教員、保護者等の引率者も**各校2名までは無料です**。3人目以降の引率者は、参加費をお支払いいただく必要があります。

生態学会では、**大学学部生以下が聴講のみ参加する場合も無料**です。発表しない学生の方も、ぜひご参加ください。
...
2. ログイン後、ホーム画面の「発表・プロフィールを登録する」を選び、ポスターとグラフィカルアブストラクト、必要に応じて説明動画をアップロードしてください。
