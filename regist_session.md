...
- 発表用のPCは**企画者・講演者が持ち込んだPCを使用していただきます**。[会場に設置されている一般発表用PC](presentation#共通の注意点)を使用することはできません。
- いずれの集会も企画者・講演者は生態学会員に限ります。ただし、シンポジウムに限り非会員の方に招待講演をしていただくことは可能です（[会員種別ごとの講演資格](registinfo#会員種別ごとの講演資格)参照）。
- シンポジウム・自由集会の企画者・講演者は、他の集会の企画者・講演者、一般講演の講演者になることはできません。また本大会では、一人一講演が原則となり、自由集会と一般講演の組み合わせの発表もできません（[一人一講演（？）](＠リンク)参照）。
- 要旨登録を伴わない趣旨説明やコメント、意見表明などは講演には数えません。よって、これらの形での集会参加は、非会員の方でも可能であり、重複制限の対象にもなりません。
    - ただし、**上記の要旨登録を伴わない形で集会へ参加する場合でも、大会参加申込みが必要です。企画者は注意喚起をお願いします**。
